...
class TestEnvoiceUblGenerator < Minitest::Test
  ...
  def test_ubl_invoice_file_be_to_be
    ...
    document.add_attachment(absolute_file_name: dummy_pdf_filename, id: 'F2024-005', description: "Invoice F2024-005", mime_type: 'application/pdf')
  ...
  def test_ubl_credit_note_file_be_to_be
    ...
    document.add_attachment(absolute_file_name: dummy_pdf_filename, id: 'C2024-005', description: "Credit Note C2024-005", mime_type: 'application/pdf')
